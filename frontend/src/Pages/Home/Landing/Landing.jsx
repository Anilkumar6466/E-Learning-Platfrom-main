  ...
  return (
    ...
    {/* Top Section */}
      <div className="top">
        <div className="left">
          <h1>
          Empowering Minds, Inspiring Futures: <br />Your Gateway to Online Learning with <span className="font-semibold text-amber-400 font-serif text-5xl">Doctor Reddy's</span>
          </h1>
          {/*  Search  */}
          ...
          <div className="search mb-10">
            ...
            <input type="text" placeholder='Ex: web3 ...' value={subject} onChange={(e)=>setSubject(e.target.value)}/>
      ...
      <div className="flex items-center justify-center gap-10">
        {!loading && facList && (
          ...
          <div key={fac._id} className="bg-[#99afbc] p-5 rounded-md ">
            ...
            { fac.enrolledteacher.Email === "vikramdeveloper28@gmail.com" ?
            ...
            { fac.enrolledteacher.Email === "vikramdeveloper28@gmail.com" ? <h4>1 years of teaching experience</h4> : <h4>2 years of teaching experience</h4>}
          </div>
        )))}
      </div>
      ...
      <div className="about" style={{backgroundColor: "#042439"}}>
        ...
        <div className="content">
          ...
          <p>
            At Doctor Reddy's, we believe in the power of education to transform lives. Our platform is designed to be a gateway to knowledge, offering a diverse range of courses and learning experiences for students.
            <h1 className=" bg-blue-700 w-fit py-1 px-3 rounded-sm my-2">Our Story</h1>
            Doctor Reddy's was born out of a passion for learning and a desire to make quality education accessible to everyone. We understand the challenges faced by modern learners and strive to provide a solution that is both convenient and effective.
