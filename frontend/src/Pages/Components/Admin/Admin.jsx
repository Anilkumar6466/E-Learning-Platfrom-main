    ...
    ? TeacherData.map((teacher) =>
        teacher.Isapproved === "pending" ? (
          <div
            ...
            className="flex justify-between items-center mt-8 p-8 bg-blue-gray-600 rounded-md cursor-pointer hover:bg-blue-gray-500 transition duration-200"
          >
            <h1 className="text-[24px] text-white">{teacher.Firstname + " " + teacher.Lastname}</h1>
